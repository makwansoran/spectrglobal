...
const { getCompanyFinancials } = require("../server/company-financials");
...
module.exports = async (req, res) => {
  ...
  try {
    ...
    console.error("get-company-financials", err);
    res.status(500).json({ error: "Failed to load company financials" });
  }
};
