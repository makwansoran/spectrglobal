...
const intro =
  "Whether you want the free WMS running on your floor, a robotics pilot, or just a straight answer about whether we can help — this reaches us directly.";
              ...
              <aside>
                ...
                <div className="mt-10 border-t border-border pt-8">
                  ...
                  <p className="mt-4 text-sm leading-7 text-muted">
                    We reply to everything within one working day. Requests for the free WMS get a
