...
export const solutionsHub: HubPage = {
  ...
  description: "Spectr OS across manufacturing, logistics, shipping, energy, mining, operations, and waste management.",
  ...
  columnOne:
    "Our platforms are for public, private, and operational institutions that have to implement solutions to the hardest problems they face — factories, warehouses, grids, fronts, wards, and books.",
  columnTwo:
