...
export const spectrBootcamp = {
  ...
  body: "SPECTR BOOTCAMP is a one-video course on building a model with your own data, wiring it into a workflow, and running it locally — on your machines, not someone else’s cloud. The five steps below are the plan. The course itself is only available to signed-in accounts.",
  courseLabel: "1 video course",
  cta: "Open bootcamp →",
  attendTitle: "Want to attend?",
  attendBody:
    "Log in first. SPECTR BOOTCAMP is not open on the public site — you need a Spectr account to play the course.",
