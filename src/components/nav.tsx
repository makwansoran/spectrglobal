  ...
  return (
    <header className="pointer-events-none fixed inset-x-0 top-0 z-50">
      <div className="container-x pointer-events-auto pt-4 sm:pt-5">
        <div className={`nav-island ${open ? "nav-island-open" : ""}`}>
          <div className="flex h-14 items-center justify-between gap-6 px-4 sm:px-5">
          ...
          {open ? (
            <div id="mobile-nav" className="border-t border-white/10 px-4 pb-4 pt-3 sm:px-5 md:hidden">
