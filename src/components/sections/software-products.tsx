              ...
              >
                {product.previewImage ? (
                  <div className="solution-card__preview" aria-hidden="true">
                    <div className="solution-card__preview-frame relative h-full w-full overflow-hidden bg-black/20">
                      <Image
                ...
                <div className="relative z-10 grid items-center gap-6 sm:grid-cols-[minmax(0,1fr)_minmax(0,1.2fr)] sm:gap-10">
                  <div>
